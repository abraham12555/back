...
public class ObjectFactory {
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cl.engine.ksms.mx/", name = "save_cadena_bc")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cl.engine.ksms.mx/", name = "calculateDictamenDePoliticasResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cl.engine.ksms.mx/", name = "calculateDictamenDePerfil")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cl.engine.ksms.mx/", name = "save_cadena_bcResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cl.engine.ksms.mx/", name = "calculateDictamenDePerfilResponse")
