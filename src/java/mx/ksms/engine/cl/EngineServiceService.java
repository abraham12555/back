 ...
 * 
 */
@WebServiceClient(name = "EngineServiceService", targetNamespace = "http://cl.engine.ksms.mx/", wsdlLocation = "http://172.20.10.2:8080/decision-engine-ws/services/engine?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://172.20.10.2:8080/decision-engine-ws/services/engine?wsdl");
