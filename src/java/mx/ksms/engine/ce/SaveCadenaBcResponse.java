...
/**
 * <p>Clase Java para save_cadena_bcResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="save_cadena_bcResponse">
 *   &lt;complexContent>
...
@XmlType(name = "save_cadena_bcResponse", propOrder = {
    "string"
})
public class SaveCadenaBcResponse {
