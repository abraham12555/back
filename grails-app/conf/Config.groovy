...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	...
	'/**/favicon.ico':  ['permitAll'],
        ...
        '/dashboard/reportes': ['ROLE_ADMIN','ROLE_DIRECTOR'],
        '/notificaciones/**':  ['ROLE_ADMIN','ROLE_DIRECTOR'],
        ...
        '/usuario/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
        '/rubroDeAplicacionProducto/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
        '/tipoDeDocumento/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
        '/tipoDeAsentamiento/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
        '/tipoDeVivienda/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
        '/tipoDeTasaDeInteres/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
        '/tipoDeCampo/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
        '/tipoDeContrato/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
        '/tipoDeFotografia/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
        '/tipoDeGarantia/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
        '/tipoDeIngresos/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
        '/seguroSobreDeuda/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
        '/servicioDeAsistencia/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
        '/tipoDeIngresos/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
        '/pasoCotizadorEntidadFinanciera/**':    ['ROLE_ADMIN','ROLE_ADMINISTRADOR'],
