	...
	def authenticate() {
		...
		try {
			...
			if (!request.containsKey("customer_id")) {
				response.error_class = "Existe un problema de Comunicaci髇, Favor de Volver a intentarlo."
