<div class="seguro-form0 elige-un-modelo borderGrayTop">
    <h1 class="lightGray letterspacing1 font20 fontWeight400 marginLeft15 marginTop15 marginBottom10">Elige tu Seguro</h1>
</div>
<div class="seguro-form1 cotizador-box-container padding20 marginTop10">
        ...
        <div class="col12 floatLeft">
            <div class="seguroElement cotizador-box lightGray clearFix marginTop15">
                ...
                <div class="floatRight width219 paddingRight10">
                    <p class="paddingTop20 font18 fontWeight500 letterspacing1 floatRight ">$1,400.00</p>
                    <p class="paddingTop10 paddingBottom20 font12 fontWeight500 letterspacing1 floatRight ">MXN / MENSUAL COMPLETO</p>
                </div>
            </div>
        </div>
        <div class="col12 floatLeft">
            <div class="seguroElement cotizador-box lightGray clearFix marginTop15">
                ...
                <div class="floatRight width109 paddingRight10">
                    <p class="paddingTop20 font18 fontWeight500 letterspacing1  ">$620</p>
                    <p class="paddingTop10 paddingBottom20 font12 fontWeight500 letterspacing1  ">MXN / MENSUAL</p>
                </div>
            </div>
        </div>
        <div class="col12 floatLeft">
            <div class="seguroElement cotizador-box lightGray clearFix marginTop15">
                ...
                <div class="floatRight width109 paddingRight10">
                    <p class="paddingTop20 font18 fontWeight500 letterspacing1">$270</p>
                    <p class="paddingTop10 paddingBottom20 font12 fontWeight500 letterspacing1  ">MXN / MENSUAL</p>
                </div>
            </div>
        </div>
...
<div class="seguro-form2 borderGrayTop borderGrayBottom paddingBottom10 clearFix elige-un-modelo">
    ...
    <div class="cambiar-seguro col4 col12-mob floatRight">
        <div class="floatRight paddingTop5 marginBottom16">
