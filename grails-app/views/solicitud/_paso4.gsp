<section id="consultaBancaria"
		...
		<div class="container clearFix relative autoMargin width920">
			<div class="infoBox  desktop ">
				<div class="width850 autoMargin">
					<p
						class="displayInline width570 floatLeft letterspacing0.5 font11 paddingLeft15 paddingTop15 paddingBottom10">
						CONECTAR TU CUENTA DE BANCO NOS PERMITE <span class="headingColor">APROBAR
							TU SOLICITUD EN MINUTOS</span> O PUEDES SUBIR TUS ESTADOS DE CUENTA Y
						ESPERAR A QUE EL EQUIPO DE KOSMOS LO REVISÉ LO MAS RÁPIDO POSIBLE
					</p>
					<div class="blueBox1 width235 floatRight marginTop12">
						<p
							class="textUpper colorWhite center font11 paddingTop10 paddingBottom10">SUBIR
							MI ESTADO DE CUENTA</p>
					</div>
				</div>
			</div>
			<div class="line18 floatLeft"></div>
			<div class="crosCircle floatLeft">
				<p class="center cross">
		...
		<div class="container clearFix relative autoMargin width920">
			<div class="infoBoxGreen floatLeft">
				<div class="infoContainer4c">
					<p
						class="center letterspacing0.5 font13 paddingLeft15 paddingTop15 paddingBottom10 colorWhite marginTop5">TUS
						DATOS BANCARIOS SE RECIBIERON EXITOSAMENTE, POR FAVOR VERIFICA QUE
						TU INFORMACIÓN SEA CORRECTA</p>
				</div>
			</div>
			<div class="line18 colorGreen floatLeft"></div>
			<div class="crosCircle colorGreen floatLeft">
				<p class="center cross colorWhite">
					<i class="fa fa-times colorWhite" aria-hidden="true"></i>
				</p>
			</div>
		</div>
	</div>
	...
	<div class="box4B marginBottom30 marginTop30">
		<div id="consultarInfo" class="bankStep">
			<p
				class="gray font14 paddingTop20 paddingLeft20 marginLeft15 marginBottom10">ELIGE
				TU BANCO</p>
			<div class="clearFix padding10">
				<div class="width160 brandingBox  floatLeft bankButton">
					<img class="width120 blockAuto paddingTop20"
						src="${resource(dir:'images', file:'banamex.png')}"
						data-hover="banamex" />
				</div>
				<div class="width160 brandingBox floatLeft bankButton">
					<img class="width120 blockAuto paddingTop20"
						src="${resource(dir:'images', file:'bancomer.png')}"
						data-hover="bancomer" />
				</div>
				<div class="width160 brandingBox floatLeft bankButton">
				...
				<div class="width160 brandingBox floatLeft bankButton">
					<img class="width120 blockAuto paddingTop20"
						src="${resource(dir:'images', file:'santander.png')}"
						data-hover="santander" />
				</div>
				<div class="width160 brandingBox floatLeft bankButton">
					<img class="width120 blockAuto paddingTop20"
						src="${resource(dir:'images', file:'banorte.png')}"
						data-hover="banorte" />
				</div>
			...
			<div id="accionesNormal" class="paddingTop20 clearFix">
				<div class="floatLeft col6 col12-mob">
					<div class="padding10">
						<div
							class="consultarBox marginLeft15 center colorWhite letterspacing1 font16">
							CONSULTAR DE FORMA SEGURA <i class="fa fa-lock paddingLeft10"
								aria-hidden="true"></i>
						</div>
					</div>
				</div>
			...
			<div id="accionesError" style="padding-top: 50px;"
				class="padding10 clearFix marginTop15 hide">
				<div class="col6 col12-tab col12-mob floatLeft">
					<div class="paddingAside10">
						<div
							class="coneccionFallida center colorWhite .letterspacing1.5 font16">CONEXIÓN
							FALLIDA</div>
					</div>
				</div>
				<div class="col6 col12-tab col12-mob floatLeft clearFix">
					<div class="col5 col12-mob floatLeft">
						<div class="paddingAside10">
							<a id="reintentarBtn">
								<div
									class="darkGray buttonM radius100 colorWhite font16 .letterspacing1.5 mobileAuto">reintentar</div>
							</a>
						</div>
					</div>
					<div class="col7 col12-mob floatLeft">
						<div class="paddingAside10">
							<a id="subirEstadosDeCuentaBtn">
								<div
									class="colorGreen radius100 buttonM colorWhite font16 .letterspacing1.5 mobileAuto">subir
									estados de cuenta</div>
							</a>
						</div>
					</div>
				</div>
		...
		<div id="confirmarConsulta" style="display: none;"
			class="bankStep hide">
			<p
				class="gray font14 paddingTop20 paddingLeft20 center marginBottom10">DATOS
				RECIBIDOS</p>

			<div class="clearFix padding15">

				<div class="floatLeft paddingTop20 col4 col12-mob">
					<p class="marginBottom15 gray font14">DEPOSITOS PROMEDIO (90
						DÍAS)</p>
					<input class="inPuts4B paddingLeft15 headingColor formValues"
						type="text" id="dep90" name="depositos"
						placeholder="$55,000.00 MXN" />

					<div class="paddingTop20 clearFix confirmInfo">
						<p class="marginBottom15 gray font14">¿ESTA INFORMACIÓN ES
							CORRECTA?</p>
				...
				<div class="floatLeft paddingTop20 col4 col12-mob">
					<p class="marginBottom15 gray font14">RETIROS PROMEDIO (90
						DÍAS)</p>
					<input class="inPuts4B paddingLeft15 headingColor formValues"
						type="text" id="ret90" name="retiros" placeholder="$55,000.00 MXN" />
				...
				<div class="floatLeft paddingTop20 col4 col12-mob ">
					...
					<input class="inPuts4B paddingLeft15 headingColor formValues"
						type="text" id="saldo90" name="saldo" placeholder="$55,000.00 MXN" />
				...
				<div class="paddingTop20 clearFix">
					<div class="floatLeft col6 col12-mob">
						<div class="paddingAside15">
							<div
								class="consultarBox exito marginLeft15 center colorWhite letterspacing1 font16"
								style="cursor: default">CONEXIÓN EXITOSA</div>
						</div>
					</div>
					<div class="floatLeft col6 col12-mob">
						<div class="paddingAside15">
							<div
								class="confirmDb buttonM hide mobileAuto pointer colorGreen radius100 marginTop35 colorWhite letterspacing1 font16">
								CONFIRMAR MI INFORMACIÓN</div>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="padding20 width920 clearFix">
		<div class="floatLeft col5 col12-mob clearFix paddingBottom50">
			<div class="floatLeft">
				<img alt="Protection"
					src="${resource(dir:'images', file:'protection.png')}" />
			</div>
			<div class="floatRight marginLeft10 paddingTop5 rightTxt">
				<p class="formTitleColor font16 letterspacing1">PROTEGEMOS TU
					INFORMACIÓN</p>
				<p class="colorRed font14">Kosmos no guarda ningún dato
					bancario.</p>
			</div>
		</div>
		<div class="floatRight  col7 col12-mob clearFix paddingBottom50">
			...
			<div class="floatLeft marginLeft10 paddingTop5 rightTxt">
				<p class="formTitleColor font16 letterspacing1">SOMOS MÁS
					SEGUROS QUE LOS BANCOS</p>
				<p class="colorRed font14">Todos tus datos están 100% protegidos
					con la mejor seguridad en la red</p>
			</div>
		</div>
	</div>
</section>
<section id="recibosUpload" style="display: none;"
	class="container paddingTop30 paddingBottom20 clearFix contentHeight">
	<div class="box4B padding20 clearFix">
		<p
			class="center font14 letterspacing1.1 gray paddingTop36 paddingBottom38">SUBE
			TUS ÚLTIMOS 4 RECIBOS DE NÓMINA O TUS 3 ULTIMOS ESTADOS DE CUENTA</p>
		<div class="col3 col6-tab col12-mob floatLeft">
			<div class="paddingAside15">
				<div class="folderContainer marginTop15 mobileAuto ">
					<img class="folderImage"
						src="${resource(dir:'images', file:'folder.png')}" alt="folder"
						title="folder" />
					<p class="center letterspacing1.4 gray">Mes 1</p>
				</div>
				<div
					class="colorGreen radius100 buttonM marginTop20 colorWhite font16 mobileAuto ">
					subir</div>
			</div>
		</div>
		<div class="col3 col6-tab col12-mob floatLeft">
...
<footer class="footerContainer">
	<form class="sendValues" name="formPaso4" id="formPaso4" method="post">
		<input type="hidden" name="siguientePaso" id="siguientePaso" value="5">
	</form>
	<div class="width600 clearFix desktop tablet">
		...
		<div class="rectangle250 center floatLeft nextBtn">
			<p class="textUpper footerTextColor font18 paddingTop10">ir al
				paso 5</p>
		</div>
		<div class="line20 floatLeft"></div>
		<div class="grayCircle center floatLeft">
