        ...
        <div id="consultarInfo" class="bankStep">
            ...
            <div class="clearFix paddingLeft10">
                ...
                <div class="floatLeft paddingTop20 col4 col6-tab col12-mob">
                    ...
                    <input class="inPuts4a formValues textUpper headingColor" type="text" id="clientNo" name="clientNo" placeholder="no. de cliente"/>
                </div>
                <div class="floatLeft paddingTop20 col4 col6-tab col12-mob">
                    <p class=" marginBottom15 gray font14">CLAVE</p>
                    <input class="inPuts4a formValues headingColor" type="password" id="clave" name="clave" placeholder="·······"/>
                </div>
                <div class="floatLeft paddingTop20 col4 col6-tab col12-mob">
...
<footer class="footerContainer">
    ...
    <div class="width600 clearFix desktop tablet">
        ...
        <div class="rectangle250 center floatLeft nextBtn">
            <p class="textUpper footerTextColor font18 paddingTop10">ir al paso 5</p>
        </div>
        <div class="line20 floatLeft"></div>
        <div class="grayCircle center floatLeft">
