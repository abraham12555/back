        ...
        <p class="font35 marginTop28 letterspacing1 formTitleColor lineHeight60">
            <span class="hide showOnFill">Mi nivel escolar es
                <span class="width240 inline selectWrap">
                    <g:if test="${generales?.nivelEscolar}">
                        <g:select id="nivelEscolar" name="nivelEscolar" class="formulariOptions width100 gray formValues notEmpty headingColor"  from="${escolaridadList}" optionKey="id" noSelection="['':'Nivel Escolar']" value="${generales?.nivelEscolar}"/>
                    </g:if>
                    <g:else>
            ...
            <span class="hide showOnFill"> y mi número telefónico es el
                ...
                <input type="text" class="inputsFormulario width500 headingColor formValues <g:if test="${generales?.conyugue}"> notEmpty headingColor </g:if>" name="nombreConyugue" placeholder="Maria Hernández Pérez" value="${generales?.conyugue}">
                </span>
                <span class="hide showOnFill">
                , de mi dependen&nbsp;
