<section class="container paddingBottom38">
    <div class="paddingBottom15">
        <button class="blueButton colorWhite textUpper width100 center radius4 paddingTop8 paddingBottom9 font12" type="button" title="Configuración envío" onclick="seleccionTipoDeEnvioEnvio();"><b class="font14">+</b> agregar</button>
    </div>
