...
<html>
    ...
    <body>
        ...
        <section class="container">
            <div class="col12 clearFix">
                <div class="autoMargin radius2 solicitudWhiteBox">
                    ...
                    <div class="radius2 lightGrayBG autoMargin">
                        <ul class="clearFix marginLeft10 solicitude_submenu">
                            <li class="floatLeft marginLeft8">
                                <a id="datosGeneralesButton" onclick="mostrarTab('datosGenerales');" class="opcionMenuSolicitud displayInline font14 fontWeight300 blueButton paddingTop10 paddingBottom10 paddingLeft20 paddingRight20 pointer">Datos Generales</a>
                            </li>
                            <li class="floatLeft">
                                <a id="capacidadDePagoButton" onclick="mostrarTab('capacidadDePago');" class="opcionMenuSolicitud displayInline font14 fontWeight300 gray paddingTop10 paddingBottom10 paddingLeft20 paddingRight20 pointer">Capacidad de Pago</a>
                            </li>
                            <li class="floatLeft">
                                <a id="historialCrediticioButton" onclick="mostrarTab('historialCrediticio');" class="opcionMenuSolicitud displayInline font14 fontWeight300 gray paddingTop10 paddingBottom10 paddingLeft20 paddingRight20 pointer">Historial Crediticio</a>
                            </li>
                            <li class="floatLeft">
                                <a id="scoreButton" onclick="mostrarTab('score');" class="opcionMenuSolicitud displayInline font14 fontWeight300 gray paddingTop10 paddingBottom10 paddingLeft20 paddingRight20 pointer">Score</a>
                            </li>
                            <li class="floatLeft">
        ...
        <div class="solicitudTab" id='datosGenerales'>
                        ...
                        <div class="col6 col12-tab floatLeft">
                            <div class="boxMargins solicitudWhiteBox radius2 paddingBottom12 marginBottom20">
                                ...
                                <div class="paddingLeft30 lightGrayBG clearFix paddingTop10">
                                    <img class="floatLeft paddingRight5" src="${resource(dir:'images', file:'bluestar.png')}" alt="star" />
                                    <img class="floatLeft paddingRight5" src="${resource(dir:'images', file:'halfstar.png')}" alt="star" />
                                    <img class="floatLeft paddingRight5" src="${resource(dir:'images', file:'star.png')}" alt="star" />
                                    <img class="floatLeft paddingRight5" src="${resource(dir:'images', file:'star.png')}" alt="star" />
                                    <img class="floatLeft paddingRight5" src="${resource(dir:'images', file:'star.png')}" alt="star" />
                                </div>
                            </div>
        ...
        <div class="solicitudTab" id='capacidadDePago' style='display: none;'>
            <section class="container">
                <div class="padding20">
                    ...
                    <div class="col8 col6-tab col12-mob floatLeft clearFix">
                        <div class="col6 col12-tab floatLeft">
                            <div class="boxMargins solicitudWhiteBox radius2 paddingBottom12 marginBottom20">
                                ...
                                <div class="paddingLeft30 lightGrayBG">
                                    <p class="font12 fontWeight500 gray paddingTop10">TEMPORALIDAD</p>
            ...
            <section class="container">
                <div class="col12 clearFix">
                    ...
                    <div class="col6 col12-mob floatLeft">
                        <div class="mobileAside10 solicitudWhiteBox height251 radius2 paddingBottom12 marginBottom20" >
                            <div class="navyBg radius2">
                                <p class="paddingLeft30 colorWhite letterspacing2 fontWeight600 font18 paddingTop15 paddingBottom10">% DE MOP</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="solicitudTab" id='historialCrediticio' style='display: none;'>
            <section class="container">
                <div class="padding20">
        ...
        <div class="solicitudTab" id='score' style='display: none;'>
            ...
            <div class="solicitudLightbox hide" id="autorizar_credito">
                <div class="overlay"></div>
                <div class="loginContainer creditLb">
                    <div class="dashBordBox">
                        <form class="loginForm gray font14">
                            ...
                            <div class="formContainer">
                                <input class="inputs marginBottom30 lightGray letterspacing1 font14" type="text" placeholder="Contraseña" value=""/>
                                <button class="loginButton blueButton letterspacing2 font14">AUTORIZAR</button>
                            </div>
                        </form>
                    </div>
