<div id="listaDeEntidades">
    <g:each var="entidad" in="${entidadesList}">
                ...
                <div class="clearFix">
                    <div class="col1fifth col6-tab col12-mob floatLeft">
                        <div class="borderGrayRight removeMobile marginLeft30 paddingTop15 paddingBottom10">
                            <p class="font12 gray2 marginBottom5">NOMBRE</p>
                            <p class="font14 gray2">${entidad.nombre}</p>
                        </div>
                    </div>
                    <div class="col1fifth col6-tab col12-mob floatLeft">
                        <div class="borderGrayRight removeMobile marginLeft30 paddingTop15 paddingBottom10">
                            <p class="font12 gray2 marginBottom5">FECHA DE REGISTRO</p>
                            <p class="font14 gray2"><g:formatDate format="dd/MM/yyyy HH:mm" date="${entidad.fechaDeRegistro}" /> </p>
                        </div>
                    </div>
                    <div class="col1fifth col6-tab col12-mob floatLeft">
                        <div class="borderGrayRight removeMobile marginLeft30 paddingTop15 paddingBottom10">
                            <p class="font12 gray2 marginBottom5">ESTATUS</p>
                            <p class="font14 gray2">${(entidad.activa ? "ACTIVA" : "INACTIVA")}</p>
                        </div>
                    </div>
