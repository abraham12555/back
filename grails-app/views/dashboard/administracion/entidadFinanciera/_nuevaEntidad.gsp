...
<div class="loginContainer creditLb">
    <div class="dashBordBox">
        <form id="crearEntidadForm" class="loginForm gray font14">
            ...
            <div class="formContainer">
                <input class="inputs marginBottom30 lightGray letterspacing1 font14" name="nombreEntidad" type="text" required placeholder="Nombre de la Entidad Financiera"/>
                <button type="button" class="loginButton blueButton letterspacing2 font14 pointer" onclick="guardarNuevaEntidad();">REGISTRAR</button>
