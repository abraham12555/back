<g:if test="listaTipoDeGarantia">
    <g:each var="lista" in="${listaTipoDeGarantia}">
                ...
                <div class="clearFix">
                    ...
                    <div class="col1fifth col12-tab col12-mob floatLeft">
                        <div class="marginTop10 marginBottom10 clearFix paddingAside10">
                            <a title="Editar" onclick="editarTipoDeGarantia(${lista.id});" class="tabNoFloat floatRight marginLeft20 block width115 blueButton center radius4 paddingTop10 paddingBottom10 pointer">EDITAR</a>
                        </div>
                    </div>
                </div>
            </div>
...
<g:render template="configuracion/tipoDeGarantia/altaTipoDeGarantia"/>
<div id="detalleTipoDeGarantia"></div>