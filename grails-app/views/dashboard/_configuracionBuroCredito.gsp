    ...
    <div class="width990 autoMargin solicitudWhiteBox clearFix paddingBottom20">
        <form id="configuracionBuroCreditoForm" class="loginForm gray font14">
            ...
            <div class="formContainer">
                ...
                <label>CONTRASEÑA.</label><input class="inputs marginBottom30 lightGray letterspacing1 font14" name="encabezadoPassword" id="encabezadoPassword" type="password" required placeholder="Contraseña Buró de Crédito" value="${configuracionBuroCredito?.encabezadoPassword}"/>
