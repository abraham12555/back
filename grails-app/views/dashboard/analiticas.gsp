            ...
            <div class="col12 clearFix radius2 solicitudBox">
                <div class="lightGrayBG marginTop12">
                    <ul class="clearFix solicitude_submenu">
                        <li class="floatLeft">
                            <a id="subMenuOpc1" onclick="genererarEstadisticasPor(1,'rangoDeFechas',null,null);" title="Dia" class="elementoSubMenu displayInline blueButton font16 fontweight300  paddingTop10 paddingBottom10 paddingLeft20 paddingRight20 pointer">Día</a>
                        </li>
                        <li class="floatLeft">
                            <a id="subMenuOpc7" onclick="genererarEstadisticasPor(7,'rangoDeFechas',null,null);" title="Semana" class="elementoSubMenu displayInline gray font16 fontweight300  paddingTop10 paddingBottom10 paddingLeft20 paddingRight20 pointer">Semana</a>
                        </li>
                        <li class="floatLeft">
                            <a id="subMenuOpc31" onclick="genererarEstadisticasPor(31,'rangoDeFechas',null,null);" title="Mes" class="elementoSubMenu displayInline gray font16 fontweight300  paddingTop10 paddingBottom10 paddingLeft20 paddingRight20 pointer">Mes</a>
                        </li>
                        <li class="floatLeft">
                            <a id="subMenuOpc365" onclick="genererarEstadisticasPor(365,'rangoDeFechas',null,null);" title="Año" class="elementoSubMenu displayInline gray font16 fontweight300  paddingTop10 paddingBottom10 paddingLeft20 paddingRight20 pointer">Año</a>
                        </li>
                        <li class="floatLeft">
                            <a id="subMenuOpc5" onclick="genererarEstadisticasPor(5,'rangoDeFechas','from','to');" title="Por Fecha" class="elementoSubMenu displayInline gray font16 fontweight300  paddingTop10 paddingBottom10 paddingLeft20 paddingRight20 pointer">Por Fecha</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="lightGrayBG" style="height: 100%;">
                    <div class="col12 floatLeft" style="padding: 15px;">
                        ...
                        <div class="col4 floatLeft">
                            <center>
                                <li>
                                    <a onclick="genererarEstadisticasPor(0,null,null,null);" title="Buscar" class="displayInline blueButton font16 fontweight300  paddingTop10 paddingBottom10 paddingLeft20 paddingRight20 pointer">Buscar</a>
                                </li>
                            </center>
                        </div>
                    </div>
