    ...
    <body>
            ...
            <div class="col12 clearFix radius2 solicitudBox">
                ...
                <div class="lightGrayBG marginTop12">
                    <ul class="clearFix solicitude_submenu">
                        <li class="floatLeft">
                            <a href="#" title="Dia" class="displayInline blueButton font16 fontweight300  paddingTop10 paddingBottom10 paddingLeft20 paddingRight20">Día</a>
                        </li>
                        <li class="floatLeft">
                            <a href="#" title="Semana" class="displayInline gray2 font16 fontweight300  paddingTop10 paddingBottom10 paddingLeft20 paddingRight20">Semana</a>
                        </li>
                        <li class="floatLeft">
                            <a href="#" title="Mes" class="displayInline gray2 font16 fontweight300  paddingTop10 paddingBottom10 paddingLeft20 paddingRight20">Mes</a>
                        </li>
                        <li class="floatLeft">
                            <a href="#" title="Año" class="displayInline gray2 font16 fontweight300  paddingTop10 paddingBottom10 paddingLeft20 paddingRight20">Año</a>
                        </li>
                        <li class="floatLeft">
                            <a href="#" title="Por Fecha" class="displayInline gray2 font16 fontweight300  paddingTop10 paddingBottom10 paddingLeft20 paddingRight20">Por Fecha</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <section class="container width990">
            <div class="wrapper clearFix">
                ...
                <div class="col12 floatLeft clearFix marginBottom84">
