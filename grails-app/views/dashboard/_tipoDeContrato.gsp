<g:if test="listaTipoDeContrato">
    <g:each var="lista" in="${listaTipoDeContrato}">
                ...
                <div class="clearFix">
                    ...
                    <div class="col1fifth col12-tab col12-mob floatLeft">
                        <div class="marginTop10 marginBottom10 clearFix paddingAside10">
                            <a title="Editar" onclick="editarTipoDeContrato(${lista.id});" class="tabNoFloat floatRight marginLeft20 block width115 blueButton center radius4 paddingTop10 paddingBottom10 pointer">EDITAR</a>
                        </div>
                    </div>
                </div>
            </div>
...
<g:render template="configuracion/tipoDeContrato/altaTipoDeContrato"/>
<div id="detalleTipoDeContrato"></div>