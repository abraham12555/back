          ...
          <div class="radius2 lightGrayBG autoMargin">
            <ul class="clearFix marginLeft10 solicitude_submenu">
              <li class="floatLeft marginLeft8">
                <a href="#" class="displayInline font14 fontWeight300 gray paddingTop10 paddingBottom10 paddingLeft20 paddingRight20">Datos Generales</a>
              </li>
              <li class="floatLeft">
                <a href="#" class="displayInline font14 fontWeight300 gray paddingTop10 paddingBottom10 paddingLeft20 paddingRight20">Capacidad de Pago</a>
              </li>
              <li class="floatLeft">
                <a href="#" class="displayInline font14 fontWeight300 gray paddingTop10 paddingBottom10 paddingLeft20 paddingRight20">Historial Crediticio</a>
              </li>
              <li class="floatLeft">
                <a href="#" class="displayInline font14 fontWeight300 gray paddingTop10 paddingBottom10 paddingLeft20 paddingRight20">Score</a>
              </li>
              <li class="floatLeft">
                <a href="#" class="displayInline font14 fontWeight300 gray paddingTop10 paddingBottom10 paddingLeft20 paddingRight20">Documentación</a>
              </li>
              <li class="floatLeft">
                <a href="#" class="displayInline font14 fontWeight300 blueButton paddingTop10 paddingBottom10 paddingLeft20 paddingRight20">Visita Ocular</a>
              </li>
            </ul>
          </div>
        </div>
              ...
              <div class="col4 col12-mob floatLeft">
                <div class="paddingAside15 marginBottom20">
                  <div class="grayBorderBox center">
                    <img src="images/photo.svg" alt="Photo" class="paddingTop7 paddingBottom10">
            ...
            <div class="">
              <div class="grayBG-visita radius10 height260 autoMargin clearFix">
                <div class="profileBG floatLeft marginLeft17 marginTop65">
                  <img class="imgResponsive" src="images/user.png" alt="user" />
                </div>
              </div>
            </div>
          ...
          <div class="padding15">
            ...
            <div class="grayBG-visita2 height535 autoMargin BigGrayBox">
              <div class="clearFix alert-visita">
                <img src="images/info-red.svg" alt="Info-Red" class="floatLeft padding20">
